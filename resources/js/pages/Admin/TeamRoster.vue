...
<template>
    ...
    <div class="space-y-6">
        ...
        <section class="grid gap-6 xl:grid-cols-[0.92fr_1.08fr]">
            <section class="page-card rounded-3xl border border-[#034485]/35 bg-white p-5 text-slate-900">
                <div class="flex items-start justify-between gap-3">
                    ...
                    <Link
                        :href="`/teams/${team.id}/manage-coaches`"
                        class="rounded-full border border-[#034485]/25 bg-white px-3 py-1.5 text-xs font-semibold text-[#034485] hover:bg-[#EAF4FF]"
                    >
                        Edit
                    </Link>
                </div>
            ...
            <section class="page-card rounded-3xl border border-[#034485]/35 bg-white p-5 text-slate-900">
                ...
                <div class="mt-5 grid gap-4 md:grid-cols-2">
                    <article
                        ...
                        :key="player.id"
                        class="page-card rounded-2xl border border-slate-200 bg-slate-50 p-4"
                    >
                    ...
                    <div
                        ...
                        class="page-card rounded-2xl border border-dashed border-[#034485]/25 bg-slate-50 px-4 py-10 text-center text-sm text-slate-500 md:col-span-2"
                    >
